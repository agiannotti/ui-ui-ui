            ...
            <div className="h-16 flex items-center justify-between px-4 sm:px-6">
              <a href="#!">
                <img
                  ...
                  src="https://tailwindui.com/img/logos/workflow-mark.svg?color=accent&shade=500"
                  alt="Workflow"
                />
              </a>
              <button
            ...
            <div className="mt-2 max-w-8xl mx-auto px-4 sm:px-6">
              <div className="relative text-gray-400 focus-within:text-gray-500">
                ...
                <input
                  ...
                  className="block w-full border-gray-300 rounded-md pl-10 placeholder-gray-500 focus:border-accent focus:ring-accent"
                />
